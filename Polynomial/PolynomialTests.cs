...
namespace PolynomialTask.Tests
{
    ...
    public class PolynomialTests
    {
        ...
        public void SubtractionOfPolynomials(Polynomial lhs, Polynomial rhs, Polynomial difference)
        {
            ...
            {
                var res = lhs - rhs;
                Assert.AreEqual(res, difference);
        ...
        public void Clone_Return_ShallowCopyOfPolynomial(Polynomial polynomial)
        {
            ...
            //Assert.Multiple(() =>
            {
                ...
                var originalValue = fieldInfo?.GetValue(polynomial);
                var clonnedValue = fieldInfo?.GetValue(clone);
                Assert.AreSame(originalValue, clonnedValue);
            }
            //);
        }
